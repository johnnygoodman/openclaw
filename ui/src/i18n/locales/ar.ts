...
export const ar: TranslationMap = {
  ...
  custodian: {
    ...
    sensitivePlaceholder: "أدخِل قيمة حساسة…",
    sensitiveReply: "تم إرسال الرد الحساس",
    send: "إرسال",
    thinking: "يفكّر OpenClaw",
    requestFailed: "تعذّر على OpenClaw الرد. حاوِل مرة أخرى.",
    connectionChanged: "تغيّر اتصال Gateway. أعِد المحاولة لمتابعة هذا الإعداد.",
    unsupportedGateway: "حدِّث Gateway لمتابعة الإعداد مع OpenClaw.",
  },
  mcpPage: {
